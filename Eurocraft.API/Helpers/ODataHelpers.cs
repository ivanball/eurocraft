...
namespace Eurocraft.API.Helpers
{
    /// <summary>
    ...
    public static class ODataHelpers
    {
        ...
        public static bool IsCollectionProperty(this object instance, string propertyName)
        {
            if (!HasProperty(instance, propertyName)) return false;

            var propertyInfo = instance.GetType().GetProperty(propertyName);
            var propertyType = propertyInfo.PropertyType.ToString();
            return (propertyType.Contains("ICollection"));
        }
